...
Это модель OEM-интеграции. Вы производите контроллер (SKOV, Stienen или свой бренд) со встроенным Linux-сервером. Вы ставите агента MYXON рядом со своим ПО.
