...
This is the OEM integration model. You manufacture a controller (your own brand) that ships with an embedded Linux server. You install the MYXON agent alongside your existing software.
